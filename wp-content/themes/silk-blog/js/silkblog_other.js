...
// animation for stiky menu
  $('.reveal.reveal-menu').on('open.zf.reveal', function() {
...
( function( $ ) {
  ...
  /* Flexslider ---------------------*/
    ...
    $('.slick-slider').not('.slick-initialized').slick({
      ...
      adaptiveHeight: true,
      speed: 400,
      prevArrow: '<div  class="silkblog-slider-nav silkblog-slider-prev"><i class="fa fa-angle-left" aria-hidden="true"></i></div>',
      nextArrow: '<div  class="silkblog-slider-nav silkblog-slider-next "><i class="fa fa-angle-right" aria-hidden="true"></i></div>',
      responsive: [{
        breakpoint: 1023,
        settings: {
          adaptiveHeight: true,
